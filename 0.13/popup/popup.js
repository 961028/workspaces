 ...
 * Converts the response to JSON and triggers a download.
 */
...
/**
 * Handles the file input change for importing workspace data.
 * Reads the file, parses its JSON, and sends the data to the background script.
  ...
  reader.onload = async function(evt) {
    try {
      ...
      if (response.success) {
        ...
        loadState(); // Refresh the UI state after import.
      } else {
...
// Call setupExportImportButtons in initPopup so the buttons are added when the popup loads.
